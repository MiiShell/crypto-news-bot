...
```
cd existing_repo
git remote add origin https://gitlab.com/miiproject/crypto-news-bot.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/miiproject/crypto-news-bot/-/settings/integrations)
